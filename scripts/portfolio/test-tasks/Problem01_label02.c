// RUN: %portfolio -c small_timeout.yml -t "%s" -l minimal | FileCheck "%s"

// CHECK:      -- 3. Evaluating Results --
// CHECK-NEXT: Result of config2: TIMEOUT
// CHECK-NEXT: Result of config3: TIMEOUT
// CHECK-NEXT: Final result of portfolio: NONE
...
void reach_error() { __assert_fail("0", "Problem01_label02.c", 4, "reach_error"); }
