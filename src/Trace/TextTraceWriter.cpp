...
public:
    ...
    void visit(AssignTraceEvent& event) override
    {
        ...
        mOS.indent(IndentWidth) << event.getVariable().getName() << " := ";
    ...
    {
        mOS.indent(IndentWidth) << "Undefined behavior (read of an undefined value: ";
